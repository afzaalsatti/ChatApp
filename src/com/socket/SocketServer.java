...
public class SocketServer implements Runnable {
    ...
    public SocketServer(FrameServer frame){
	...
	try{  
     ...
     public void close1() {  
    	...
    	if (server != null)    {server.close();}
         }catch (IOException ex){System.out.println("server stop..");}
        
    }
   
    
    
    public SocketServer(FrameServer frame, int Port){
